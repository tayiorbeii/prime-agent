---
name: "persona-team-ios-hig-design"
description: "Design native iOS interfaces following Apple Human Interface Guidelines. Use when the user mentions \"iPhone app\", \"iPad layout\", \"SwiftUI\", \"UIKit\", \"Dynamic Island\", \"safe areas\", \"HIG compliance\", \"SF Symbols\", \"haptic feedback\", or \"iOS accessibility\". Also trigger when building tab bars, navigation stacks, sheets, or modals for iOS, implementing dark mode, or adapting layouts for different screen sizes. Covers navigation patterns, accessibility, SF Symbols, and platform conventions. For general UI polish, see persona-team-refactoring-ui. For affordance design, see persona-team-design-everyday-things."
license: "MIT"
...
metadata:
  ...
  source-path: "skills/ios-hig-design/SKILL.md"
  source-sha256: "14bed7ac1a18a2085d8c46c68fcfd616b3552b4bbe477a20ba7fc7145b0a8b11"
---
...
See: the corresponding guidance in this skill for detailed navigation bar and tab bar specifications.
...
See: the corresponding guidance in this skill for complete text styles, font sizes, and Dark Mode typography rules.
...
See: the corresponding guidance in this skill for semantic colors, Dark Mode palette, and contrast ratio guidelines.
...
See: the corresponding guidance in this skill for tab bar, navigation bar, modals, search patterns, and split views.
...
See: the corresponding guidance in this skill for buttons, lists, input controls, menus, and confirmation dialogs. See also: the corresponding guidance in this skill for keyboard types and input patterns.
...
See: the corresponding guidance in this skill for VoiceOver implementation, Dynamic Type support, and accessibility checklist.
...
See: the corresponding guidance in this skill for icon size tables, shape specifications, and design guidelines.
...
See: the corresponding guidance in this skill for standard gesture table, haptic feedback patterns, and animation guidelines.
...
- typography.md: Text styles, font sizes, Dynamic Type, Dark Mode typography
- navigation.md: Tab bar, navigation bar, modals, search patterns, split views
- components.md: Buttons, lists, input controls, menus, confirmation dialogs
- colors-depth.md: Semantic colors, Dark Mode, contrast ratios
- gestures.md: Standard gestures, haptics, animations
- accessibility.md: VoiceOver, Dynamic Type, accessibility checklist
- app-icons.md: Icon sizes, shape, SF Symbols guidelines
- keyboard-input.md: Keyboard types, input accessory views, hardware keyboard support
- privacy-permissions.md: Permission request timing, pre-permission screens, handling denial
- widgets-extensions.md: Widget sizes, App Clips design, Live Activities
- system-integration.md: Siri, Shortcuts, Handoff, drag-drop, universal links
