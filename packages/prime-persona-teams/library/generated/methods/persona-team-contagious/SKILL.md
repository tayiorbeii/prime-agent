...
metadata:
  ...
  source-path: "skills/contagious/SKILL.md"
  source-sha256: "c81c9fe3b621d593b577f88072f3708672d4169ba9e5d92a41d4dc7057c3f4fe"
---
# Word-of-Mouth & Virality Framework

A framework for engineering word-of-mouth and making products, ideas, and content persona-team-contagious. Based on Jonah Berger's research into why certain things catch on while others languish in obscurity — and how to systematically tip the odds in your favor.
...
Six principles that make things persona-team-contagious:
...
**Not a checklist — a multiplier.** Each principle independently increases the likelihood of sharing. The most persona-team-contagious ideas activate multiple STEPPS simultaneously. But even activating one or two well can dramatically increase word-of-mouth.
...
See: the corresponding guidance in this skill for remarkability exercises and game mechanics design.
...
See: the corresponding guidance in this skill for habitat analysis and trigger design frameworks.
...
See: the corresponding guidance in this skill for emotional arousal mapping and content audit tools.
...
See: the corresponding guidance in this skill for observability design and behavioral residue strategies.
...
See: the corresponding guidance in this skill for Prospect Theory applications and knowledge packaging formats.
...
See: the corresponding guidance in this skill for narrative templates and the Trojan Horse integration test.
...
- the corresponding guidance in this skill — Remarkability techniques, game mechanics, exclusivity design, and identity signaling strategies
- the corresponding guidance in this skill — Habitat analysis, trigger frequency matrix, competitive triggers, and the Kit Kat case study
- the corresponding guidance in this skill — High-arousal vs. low-arousal emotion mapping, awe engineering, humor design, and emotional audit tools
- the corresponding guidance in this skill — Behavioral residue, observable consumption design, self-advertising products, and the Apple logo story
- the corresponding guidance in this skill — Prospect Theory for marketers, Rule of 100, knowledge packaging formats, and deal framing
- the corresponding guidance in this skill — Trojan Horse narrative design, brand integration testing, and story templates
- the corresponding guidance in this skill — Offline vs. online WOM, conversation triggers, measurement approaches, and WOM audit
- the corresponding guidance in this skill — Content formats that spread, platform-specific patterns, viral coefficient, and shareability audit
- the corresponding guidance in this skill — Detailed breakdowns of Blendtec, Barclay Prime, Kit Kat, Livestrong, Dove, and Hotmail
