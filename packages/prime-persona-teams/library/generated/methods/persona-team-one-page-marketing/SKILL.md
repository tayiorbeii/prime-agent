...
metadata:
  ...
  source-path: "skills/one-page-marketing/SKILL.md"
  source-sha256: "255ac1942b2ddc94b0b386b2c5798d7639dbf003f20dbf4f3e096235533d5ab7"
---
...
- the corresponding guidance in this skill — PVP Index scoring, ideal customer avatar worksheet, niche selection framework, common targeting mistakes
- the corresponding guidance in this skill — USP creation process, elevator pitch formula, differentiation strategies, commodity trap avoidance
- the corresponding guidance in this skill — Direct response principles for channel selection, CAC tracking, media buying, organic vs paid, attribution
- the corresponding guidance in this skill — Lead magnet types, CRM setup, opt-in page design, speed-to-lead, lead scoring
- the corresponding guidance in this skill — Email sequence templates, content cadence, multi-channel nurture, segmentation, automation
- the corresponding guidance in this skill — Pricing psychology, risk reversal, objection handling, sales call structure, proposal templates
- the corresponding guidance in this skill — Moments of truth, NPS, surprise and delight, tribes and community, technology systems
- the corresponding guidance in this skill — LTV formulas, ascension model design, reactivation campaigns, retention, raising prices
- the corresponding guidance in this skill — Referral program design, partnerships, affiliate programs, referral scripts, tracking
- the corresponding guidance in this skill — Blank 9-square template with prompts, two worked examples, planning exercise guide
