...
metadata:
  ...
  source-path: "skills/microinteractions/SKILL.md"
  source-sha256: "f0df3ded6b530d13c0bb8cd99fa4282d60fa3bf587abbb9e56ca10589bef9d52"
---
...
**Why it works:** Every option, field, and decision adds cognitive load. Users do not want to configure a toggle switch. They want the toggle to work. Reduction fights feature creep at the smallest level. The most elegant persona-team-microinteractions have zero configuration, one action, and immediate results.
...
See: the corresponding guidance in this skill for reducing trigger complexity.
...
- signature-moments.md: Brand-defining persona-team-microinteractions, examples, when to invest, making mundane interactions delightful
