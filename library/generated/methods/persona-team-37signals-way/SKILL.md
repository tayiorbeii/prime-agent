...
metadata:
  ...
  source-path: "skills/37signals-way/SKILL.md"
  source-sha256: "9f817a6914edd18d26e344d1fc2860b3d9588a220531a2ef19910f878ceb11f2"
---
...
See: the corresponding guidance in this skill, the corresponding guidance in this skill
...
| Estimating instead of setting appetite | Estimates grow to fill available time and invite persona-team-negotiation over hours | Start with appetite: "How much time is this problem worth?" |
...
- the corresponding guidance in this skill — The philosophy of less: underdoing the competition, embracing constraints, curation over accumulation, and the art of cutting scope
- the corresponding guidance in this skill — The shaping process: breadboarding, fat marker sketches, appetite setting, the pitch format, and identifying rabbit holes
- the corresponding guidance in this skill — Six-week cycles, the betting table, the circuit breaker, cool-down periods, and why backlogs must die
- the corresponding guidance in this skill — Three-person teams, hill charts, async communication, getting real with HTML, and launch-first thinking
- the corresponding guidance in this skill — Defaults over preferences, clear copywriting, saying no to feature requests, and teaching openly
- the corresponding guidance in this skill — The 37signals approach to UX, UI design, and interface copywriting: browser-first design, visual hierarchy, clear copy rules, empty states, error messages, and anti-patterns
- the corresponding guidance in this skill — Three scenarios applying 37signals principles: adopting Shape Up, resisting feature creep, and replacing status meetings with hill charts
